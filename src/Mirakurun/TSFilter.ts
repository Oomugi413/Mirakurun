...
import { StreamInfo, getTimeFromMJD, channelTypes } from "./common";
...
export default class TSFilter extends EventEmitter {
    ...
    private _onNIT(pid: number, data: any): void {
        ...
        const channelType: keyof typeof apid.ChannelType[] | undefined = data.network_id === 4 ? "BS" : (data.network_id === 6 || data.network_id === 7 ? "CS" : undefined);
        if (channelType != null) {
